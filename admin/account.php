        ...
        <div class="container">
            <div class="row account-data">
                <div class="account-data-header">
                    <h1>Account gegevens aanpassen</h1>
                </div>
                <div class="wrapper">
                    <div class="change-form">
                        <form action="change-credentials.php" method="post">
                            <div class="data-field">
                                <label for="currentname">Huidige gebruikersnaam</label>
                                <input id="currentname" type="text" name="currentname"/>
                            </div>

                            <div class="data-field">
                                <label for="currentpass">Huidig wachtwoord</label>
                                <input id="currentpass" type="text" name="currentpass"/>
                            </div>
