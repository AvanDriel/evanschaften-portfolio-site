...
<main>
    ...
    <div class="container-fluid project_page1">
        <div class="container">
                ...
                <div id="myCarousel" class="carousel slide col-sm-8" data-ride="carousel" style="padding: 0;">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <img src="../../Content/Img/objects/spraycan/slide1.png" >
                        </div>

                        <div class="item">
                            <img src="../../Content/Img/objects/spraycan/slide2.JPG">
                        </div>
                    </div>
    ...
    <div class="description">
        <h2>#layers #color #identity #history #shape #visual</h2>
    </div>
